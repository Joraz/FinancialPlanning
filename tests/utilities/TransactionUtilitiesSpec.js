...
describe("TransactionUtilities", function () {
    describe("applyTransactionsToBalance", function () {
        describe("When called with a null 'transactionInstances' parameter", function () {
        ...
        describe("When called with a null 'balance' parameter", function () {
            it("should throw an error", function () {
                chai.expect(function () {
        ...
        describe("When called with a valid 'balance' parameter and an empty array", function () {
            it("should not change the array or the balance", function () {
                var balance = 555;
        ...
        describe("When called with a valid 'balance' parameter and an array of transactionInstances", function () {
            it("should apply any due transactions that have not been processed to the balance, and mark them as processed", function () {
                var transactionInstances = [
                    {
    ...
    describe("filterTransactionTypesByUser", function () {
        ...
        describe("When called with a null 'transactionType' parameter", function () {
            it("should throw an error", function () {
                chai.expect(function () {
        ...
        describe("When called without a 'userId' parameter", function () {
            it("should return an array with all transaction types removed that have a 'user' property", function () {
        ...
        describe("When called with a 'userId' parameter", function () {
            describe("When the userId matches the user property", function () {
                it("should return that transaction type", function () {
            ...
            describe("When the userId does not match the user property", function () {
                it("should not return that transaction type", function () {
                    var filtered = TransactionUtilities.filterTransactionTypesByUser(transactionTypes, "test-user-one");
    ...
    describe("createTransactionsForNewRecurringInstance", function () {
        describe("When called with invalid parameters", function () {
            describe("When called with a null 'fromDate'", function () {
                it("should throw an error", function () {
                    chai.expect(function () {
        ...
        describe("When called with valid parameters", function () {
            describe("When called with a fromDate more than a month in the past", function () {
                it("should return an array of transactions, one for each full month between the fromDate and now", function () {
            ...
            describe("When called with a fromDate less than a full month in the past", function () {
                it("should return an array of one transaction", function () {
            ...
            describe("When called with a fromDate in the future", function () {
                it("should return an array of one transaction", function () {
    ...
    describe("bringRecurringTransactionUpToDate", function () {
        describe("When called with invalid parameters", function () {
            describe("When given a null 'transactionInstance' parameter", function () {
                it("should throw an error", function () {
                    chai.expect(function () {
        ...
        describe("When called with valid parameters", function () {
            describe("When the transaction is not active", function () {
                it("should return the transaction unchanged", function () {
                    var recurringTransactionInstance = {
            ...
            describe("When the transaction instance has no transactions on it", function () {
                it("should throw an error", function () {
                    var recurringTransactionInstance = {
            ...
            describe("When the transaction instance only has unprocessed transactions", function () {
                it("should return the transaction unchanged", function () {
                    var recurringTransactionInstance = {
            ...
            describe("When the transaction instance has at least one processed transaction", function () {
                describe("When the processed transaction has a transactionDate of at least over a month ago", function () {
                    it("should add in unprocessed transactions to bring it up to date", function () {
                        var recurringTransactionInstance = {
                ...
                describe("When the processed transaction has a transactionDate of under a month ago", function () {
                    it("should return the transaction unchanged", function () {
                        var recurringTransactionInstance = {
...
//# sourceMappingURL=TransactionUtilitiesSpec.js.map